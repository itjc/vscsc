...
extern "C" int __cdecl wmain(__in int argc, __in_ecount(argc) WCHAR ** argv)
{
    ...
    try
    {
        ft.WriteLine(
            L"\n"
            L"VSCSC.EXE 3.0 - Volume Shadow Copy Simple Client for Windows 7\n"
            L"This is a modified version of the original Volume Shadow Copy Client \n" 
			L"by Microsoft (VSHADOW.EXE), originally bundled with the Microsoft SDK 7\n" 
			L"for Windows Vista and Windows 7.\n\n"
            );
